...
<body>
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <p class="empty-hint">Motor ramp/run tests only run while flipped into Maintenance state.</p>
      <div class="btn-row">
      ...
      <p class="empty-hint">Constant-speed run - stays on until Stop motors.</p>
      <div class="btn-row">
        <button onclick="maintenanceAction('runAgua')">Move water</button>
        <button onclick="maintenanceAction('runMovimientoForward')">Move forward</button>
        <button onclick="maintenanceAction('runMovimientoBackward')">Move backward</button>
      </div>
      <div class="btn-row">
        <button class="danger" onclick="maintenanceAction('stopMotorTest')">Stop motors</button>
      </div>
      <div class="btn-row">
